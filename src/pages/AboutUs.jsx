                ...
                <div className="mt-12 grid gap-8 lg:grid-cols-2 lg:items-center">
                    <div>
                        ...
                        <div className="mt-6 flex gap-3">
                            <a href="/case-studies" className="inline-flex items-center gap-2 rounded-full border border-red-500 text-red-500 px-4 py-2 text-sm font-semibold">View Case Studies</a>
