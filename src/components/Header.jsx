      ...
      <div className="bg-red-700 text-white text-sm">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-2">
          <div className="flex items-center gap-3">
            ...
            <a href="tel:+919884927676" className="hover:underline">
              +91 98849 27676
            </a>
            <span className="opacity-60">|</span>
            <a href="tel:+917010421860" className="hover:underline">
              +91 70104 21860
            </a>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:flex gap-2 flex-wrap">
              {cities.map((c) => (
                <span
                  key={c}
                  className="px-2 py-0.5 rounded-full bg-white/10 text-white/90 text-xs"
                >
                  {c}
                </span>
              ))}
